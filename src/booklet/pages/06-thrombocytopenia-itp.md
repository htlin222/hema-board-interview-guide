...
<div class="fp"><b>第一性原理</b>　血小板數 ＝ 生產 − （破壞 ＋ 消耗 ＋ 扣押）。生產端有沒有事：典型病人看 CBC＋抹片（只有血小板低、其他兩系與形態正常）即可推定，骨髓 megakaryocyte 是有疑點時的直接證據；ITP <b>沒有任何 checkpoint test</b>，所以它不是「驗出來」的，是「驗證生產端正常 ＋ 排除同一條周邊路徑上的其他機轉」推出來的。</div>
